...
namespace ttLibJs {
    declare function _opusEncoder_make(
        sampleRate:number,
        channelNum:number,
        unitSampleNum:number
    ):number;

    declare function _opusEncoder_encode(
        encoder:number,
        pcmData:number,
        pcmSize:number,
        callback:number
    ...
    declare function _opusEncoder_close(
        encoder:number
    ):void;
    ...
    export namespace encoder {
        ...
        export class OpusEncoder {
            ...
            constructor(
                    ...
                    channelNum:number,
                    unitSampleNum:number) {
                this.encoder = _opusEncoder_make(
                    sampleRate,
                    channelNum,
                    unitSampleNum);
            ...
            public encodeBuffer(
                ...
                var result:boolean = _opusEncoder_encode(
                    this.encoder,
                    this.buf.byteOffset,
            ...
            public close():void {
                ...
                _opusEncoder_close(this.encoder);
                Module._free(this.buf.byteOffset);
                this.encoder = 0;
            }
        }
