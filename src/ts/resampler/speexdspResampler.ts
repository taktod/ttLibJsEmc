...
namespace ttLibJs {
    declare function _speexdspResampler_make(
        channelNum:number,
    ...
    declare function _speexdspResampler_resample(
        resampler:number,
        pcm:number,
        pcm_size:number,
        callbackFuncPtr:number
    ):boolean;

    declare function _speexdspResampler_close(
        resampler:number
    ):void;
    ...
    export namespace resampler {
        ...
        export class SpeexdspResampler {
            ...
            constructor(
                    ...
                    outputSampleRate:number,
                    quality) {
                this.resampler = _speexdspResampler_make(
                    channelNum,
                    inputSampleRate,
                    outputSampleRate,
                    quality
            ...
            public resampleBuffer(
                ...
                var result:boolean = _speexdspResampler_resample(
                    this.resampler,
                    this.buf.byteOffset,
            ...
            public close():void {
                ...
                _speexdspResampler_close(this.resampler);
                Module._free(this.buf.byteOffset);
                this.resampler = 0;
            }
        }
